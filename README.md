...
## Objective
Sonarqube build integration with AWS code build
...
*Note:* Working on latest LTS of Sonarqube? Ensure that prerequisite of running the same have been followed to save time.
...
4. When you run `sonar-scanner`, it says command not found?
  ** Quick Resolution:
    - Go to the root folder of your project. In my case, ~/Documents/project/sonar-qube
    - Run below two commands:
        export PATH=$PATH:~/Documents/software/sonarqube-6.7.5/bin/macosx-universal-64
        export PATH=$PATH:~/Documents/software/sonar-scanner-3.2.0.1227-macosx/bin
    - Run, sonar-scanner

    **Note:** For a permanent fix - set the above environment variable permanently.
